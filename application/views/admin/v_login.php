...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg"> <img width="320px;" src="<?php echo base_url().'assets/images/mylogo_.png'?>"></p><hr/>
    ...
    <!-- /.social-auth-links -->
    <hr/>
    <p><center>Copyright <?php echo date('Y');?> by ROD  <br/> All Right Reserved</center></p>
  </div>
  <!-- /.login-box-body -->
</div>
<!-- /.login-box -->
