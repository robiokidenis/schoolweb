...
<head>
    ...
    <title>SMKN 1 CIBUYUR | HOME</title>
                ...
                <div class="col-xs-6 col-sm-8 col-md-9">
                    <div class="header-top_address">
                        <div class="header-top_list">
                            <span class="icon-phone"></span>0284 000 000
                        </div>
                        <div class="header-top_list">
                            <span class="icon-envelope-open"></span>email@email.com
                        </div>
                        <div class="header-top_list">
                            <span class="icon-location-pin"></span>Alamat, jl apa , no 34 23455
                        </div>
                    </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <a href="<?php echo site_url('');?>" class="navbar-brand nav-brand2"><img class="img img-responsive" width="200px;" src="<?php echo base_url().'assets/images/mylogo_.png'?>"></a>
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                            <ul class="navbar-nav">
                                ...
                                <!-- <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('guru');?>">Informasi Staf</a>
                                </li>
                                <li class="nav-item">
        ...
        <div id="carousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                <div class="carousel-item active">
                    <img class="d-block" src="<?php echo base_url().'theme/images/slide_1.jpg'?>" alt="First slide">
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            <h1>Peran Guru Pada Dunia Pendidikan Secara Umum</h1>
                            <h4>Tanggung jawab yang berat itu seringnya tidak sesuai dengan apresiasi yang diberikan. <br> Maka dari itu tidak heran jika masih banyak guru tidak kompeten yang dipekerjakan.</h4>
                ...
                <div class="carousel-item">
                    ...
                    <div class="carousel-caption d-md-block">
                        <div class="slider_title">
                            ...
                            <h4>Guru berperan dalam mengatur segala hal selama proses pembelajaran berlangsung. Beberapa hal yang biasanya dilakukan seperti bertindak sebagai pemimpin, </h4>
                            <div class="slider-btn">
            ...
            <div class="col-md-3">
                <div class="foot-logo">
                    <a href="<?php echo site_url();?>">
                        <img src="<?php echo base_url().'assets/images/mylogo_white.png'?>" class="img-fluid" alt="footer_logo">
                    </a>
                    <p><?php echo date('Y');?> © copyright by <a href="mailto:robiokidenis@gmail.com" target="_blank">ROD</a>. <br>All rights reserved.</p>
                    </div>
                </div>
                <div class="col-md-3">
                    <div class="sitemap">
                ...
                <div class="col-md-3">
                    <div class="address">
                        <h3>Hubungi Kami</h3>
                        <p><span>Alamat: </span> Bekasi, Jawa Barat 12345 </p>
                        <p>Email : info@email.com
                            <br> Phone : +021 01234 5675</p>
